...
class AddGameForm(FlaskForm):
    ...
    screenshots = MultipleFileField('Скриншоты',
                                    validators=[DataRequired(), FileAllowed(['jpg', 'png'], 'Только изображения!')])
    game_files = FileField('Архив с игрой',
                           validators=[DataRequired(), FileAllowed(['zip', 'rar', '7z'], 'Только архивы!')])
